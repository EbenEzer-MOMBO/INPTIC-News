...
class RechercheWidget extends StatefulWidget {
  const RechercheWidget({Key? key}) : super(key: key);
                  ...
                  child: Builder(
                    builder: (context) {
                      ...
                      return ListView.separated(
                        ...
                        itemCount: resultRecherche.length,
                        separatorBuilder: (_, __) => SizedBox(height: 18.0),
                        itemBuilder: (context, resultRechercheIndex) {
                          final resultRechercheItem =
                              resultRecherche[resultRechercheIndex];
                          return InkWell(
                            ...
                            child: ArticleMediumWidget(
                              key: Key(
                                  'Key8tb_${resultRechercheIndex}_of_${resultRecherche.length}'),
                              image: resultRechercheItem.image,
                              titre: resultRechercheItem.titre,
                              favori: false,
                              date: resultRechercheItem.date!,
                            ),
                          );
                        },
                      );
