                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      FlutterFlowAdBanner(
                        ...
                        showsTestAd: true,
                        androidAdUnitID:
                            'ca-app-pub-8284205620205390/8086275550',
                      ),
                      Container(
                        width: double.infinity,
                        decoration: BoxDecoration(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        setState(() {
                                          _model.categorieSelectionne = 'TOUT';
                                        });
                                      },
                                      child: Column(
                                        mainAxisSize: MainAxisSize.max,
                                    ...
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        setState(() {
                                          _model.categorieSelectionne = 'SPORT';
                                        });
                                      },
                                      child: Column(
                                        mainAxisSize: MainAxisSize.max,
                                    ...
                                    itemBuilder: (context, listViewAllIndex) {
                                      ...
                                      return InkWell(
                                        ...
                                        child: ArticleMediumWidget(
                                          ...
                                          image: listViewAllArticleRecord.image,
                                          titre: listViewAllArticleRecord.titre,
                                          favori: false,
                                          date: listViewAllArticleRecord.date!,
                                        ),
                                      );
                                    },
                                  );
