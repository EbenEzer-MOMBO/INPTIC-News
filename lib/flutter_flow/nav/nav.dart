      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => DetailsWidget(
            refArticle: params.getParam(
                'refArticle', ParamType.DocumentReference, false, ['article']),
          ),
        ),
        FFRoute(
          name: 'Notifications',
        ...
        FFRoute(
          name: 'Rinitialisation',
          path: '/rinitialisation',
          builder: (context, params) => RinitialisationWidget(),
        ),
        FFRoute(
          name: 'A_propos',
          path: '/aPropos',
        ...
        FFRoute(
          name: 'Recherche',
          path: '/recherche',
          builder: (context, params) => RechercheWidget(),
        ),
        FFRoute(
          name: 'VerificationEmail',
          path: '/verificationEmail',
          builder: (context, params) => VerificationEmailWidget(),
        )
